(function(root,factory){
 ...
 function validateDisplayName(value){const valueSanitized=sanitizeDisplayName(value),length=graphemes(valueSanitized).length;return {valid:length>=1&&length<=20,value:valueSanitized,length}}
 ...
 return {FOREIGN_LANGUAGES,normalizeLanguage,sanitizeDisplayName,validateDisplayName,identityFor,keyboardRows,graphemes};
});
