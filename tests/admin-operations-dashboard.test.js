...
assert.ok(rules.includes("'reservationOrder','pickupAt','reservationPaymentType','reservationLifecycleId'"),'TV public data remains limited to display, safe identity, countdown, and reservation lifecycle fields');
