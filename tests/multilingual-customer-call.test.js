...
const cases=[
 ...
 ['P9012','ko','구천십이 번 고객님.','ko-KR','ko-KR'],
 ['P3456',undefined,'삼천사백오십육 번 고객님.','ko-KR','ko-KR'],
 ...
 ['D7890','zh-TW','칠천팔백구십 번 고객님.','ko-KR','ko-KR']
];
(async()=>{
...
assert.ok(admin.includes("callCustomer(committedOrder.customerNumber||committedOrder.orderNo||'',committedOrder.language)"),'ready/completion reuses the multilingual customer call with the committed order language');
