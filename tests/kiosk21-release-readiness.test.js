...
test('release changes do not alter protected application sources', () => {
  assert.equal(sha256(html), '13053e957bc324bc5e5417d3fd0892bd4bb1311faea35a7e36c4d9bf6518f9da');
  ...
  assert.equal(sha256(kiosk), 'ab8185edc325c9066a17e4071cbb4a723d79c09f89a3d9441e61b247ee06b612');
});
