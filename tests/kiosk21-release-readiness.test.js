...
test('release changes do not alter protected application sources', () => {
  assert.equal(sha256(html), '780f05cbcce63376db92ab3db1b1ed009760561485d560f5cd80be70f134a264');
  ...
  assert.equal(sha256(kiosk), '14429979f51ab7c926daee2d170ee287552ac695027da79b1e2519e011f76a60');
});
