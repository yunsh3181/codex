...
assert.strictEqual(cssVersion,'48.0.2','changed administrator CSS has the compact occupied-seat cache version');
...
assert.equal((html.match(/admin\.css\?v=48\.0\.2/g)||[]).length,1,'admin dashboard loads the compact occupied-seat CSS cache key exactly once');
